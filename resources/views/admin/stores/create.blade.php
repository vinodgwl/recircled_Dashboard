                    ...
                    <div class="p-4">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="Shipment ID" value="{{ $prevois_store_data['shipment_id'] ?? '' }}" name="shipment_id" id="exampleFormControlInput1">
                            </div>
                            <div class="col-md-3">
                                <label for="exampleFormControlInput1"  class="form-label">Shipping origin zipcode</label>
                                <input type="text" class="form-control" placeholder="Zipcode" value="{{ $prevois_store_data['shipping_origin_zipcode'] ?? '' }}" name="shipping_origin_zipcode" id="exampleFormControlInput1">
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="p-4">
                        <div class="row">
                             <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="Name" name="shipping_carrier_name" id="exampleFormControlInput1">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="Quantity"  name="quantity" id="exampleFormControlInput1">
                            </div>
                            <div class="col-md-3">
                                <label for="exampleFormControlInput1"  class="form-label">Total Weight(kg)</label>
                                <input type="text" class="form-control" placeholder="Total Weight" name="total_weight" id="exampleFormControlInput1">
                            </div>
